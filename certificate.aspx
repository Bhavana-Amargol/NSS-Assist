<%@ Page Language="C#" AutoEventWireup="true" CodeFile="certificate.aspx.cs" Inherits="NSS_certificate" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            &nbsp;
   <center><h1>ADD CERTIFICATE DETAILS</h1></center>
        <center>
         </div>
        <table class="container1"  align="center" style="background-image:url();background-repeat:no-repeat;background-size:cover;backdrop-filter:blur(5000px);"">
        <tr>
            <td class="auto-style3" hidden="true">Certificate id</td>
        ...
        <tr>
            <td class="auto-style2">Volunteer FirstName</td>
            <td class="auto-style15">
                <br />
                <asp:TextBox ID="TextBox2" runat="server" Height="45px" align="center"></asp:TextBox>
                <br />
                <br />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style15">
                <asp:TextBox ID="TextBox7" runat="server" Height="46px"></asp:TextBox>
                <br />
            </td>
        ...
        <tr>
            ...
            <td class="auto-style15">
                <asp:TextBox ID="TextBox8" runat="server" Height="46px"></asp:TextBox>
                <br />
                <br />
            </td>
            <td class="auto-style9">
        ...
        <tr>
            ...
            <td class="auto-style15">
                <asp:TextBox ID="TextBox9" runat="server" Height="41px"></asp:TextBox>
                <br />
                <br />
            </td>
            <td class="auto-style9">
        ...
        <tr>
            <td class="auto-style2">Certificate Name</td>
            <td class="auto-style15">
        ...
        <tr>
            <td class="auto-style2">&nbsp;CertificateDescription</td>
            <td class="auto-style15">
        ...
        <tr>
            <td class="auto-style2">Certificate Received Year</td>
            <td class="auto-style15">
        ...
        <tr>
            <td class="auto-style2">Certificate Photo</td>
            <td class="auto-style15">
                <asp:FileUpload ID="FileUpload1" runat="server" Height="40px" />
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="FileUpload1" ErrorMessage="INVALID FILE FORMAT!only jp and png format allowed" ForeColor="Red" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.png|.jpg|.JPG|.JPEG|.PNG)$"></asp:RegularExpressionValidator>
            </td>
            <td class="auto-style9">
