<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unitvieweventsmedia.aspx.cs" Inherits="NSS_unitvieweventsmedia" %>
...
<body>
  ...
  <img src="Uploads/Event Media/<%#Eval ("event_media")%>" style="height:15rem;" class="card-img-top" alt="...">
  ...
  <div class="card-body">
      <h5><%# Eval("event_name") %></h5>

    <%--<p class="card-text"><%# Eval("event_") %></p>--%>
      <h5>
          <asp:Label ID="Label12" runat="server" Text="DATE"></asp:Label>
          
          <asp:Label ID="Label1" runat="server" Style="margin-left:2rem;" Text='<%# Eval("event_conductdate") %>'></asp:Label>
      </h5>
      <h5>
          <asp:Label ID="Label14" runat="server" Text="VOLUNTEERS PARTICIPATED"></asp:Label>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [eventmedia]"></asp:SqlDataSource>
