<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deluapplied.aspx.cs" Inherits="NSS_deluapplied" %>
    ...
    <form id="form1" runat="server">
            ...
            <nav class="navbar navbar-expand-lg sticky-top " style="background-color:#32064A;border-radius:10px">
                <div class="container-fluid">
                 ...
                 <div align="center">
                      <h1 align="center" >Clear Uniform Applied List </h1>
                     <br />
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="apply_id" DataSourceID="SqlDataSource1" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Width="1055px" AllowPaging="True" AllowSorting="True">
                          <Columns>
                              <asp:BoundField DataField="apply_id" HeaderText="SLNO" SortExpression="apply_id"  ReadOnly="true" />
                              ...
                              <asp:BoundField DataField="volunteer_mail" HeaderText="MAILID" SortExpression="volunteer_mail" />
                              <%--<asp:BoundField DataField="volunteer_size" HeaderText="volunteer_size" SortExpression="volunteer_size" />
                              <asp:BoundField DataField="amount_paid" HeaderText="amount_paid" SortExpression="amount_paid" />--%>
                              <asp:BoundField DataField="apply date" HeaderText="APPLY DATE" SortExpression="apply date" />
                      ...
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [uniformapplied]" DeleteCommand="DELETE FROM [uniformapplied] WHERE [apply_id] = @apply_id">
                          <DeleteParameters>
                            <asp:Parameter Name="apply_id" Type="String" />
                        </DeleteParameters>
                      </asp:SqlDataSource>
        </div>
</div>
