<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deputymeeting.aspx.cs" Inherits="NSS_deputymeeting" %>
        ...
        <table align="center"  >
            ...
            <tr>
                ...
                <td class="coll2">
                    ...
                    <asp:Calendar ID="Calendar1" runat="server" OnDayRender="Calendar1_DayRender" OnSelectionChanged="Calendar1_SelectionChanged" VisibleDate="2022-10-01" BackColor="White" BorderColor="#999999" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px" CssClass="auto-style1" CellPadding="4" DayNameFormat="Shortest">
