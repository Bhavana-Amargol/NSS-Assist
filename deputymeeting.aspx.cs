...
public partial class NSS_deputymeeting : System.Web.UI.Page
{
    SqlConnection con;
    SqlConnection con1;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ctr == 0)
            {
                ...
                con.Close();
                Response.Write("<script>alert('meeting details added successfully!!!');window.location='deputymeeting.aspx';</script>");
            ...
            {
                Response.Write("<script>alert('couldn't add meeting details.Details already exist ');window.location='deputymeeting.aspx';</script>");
