<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deputycamps.aspx.cs" Inherits="NSS_deputycamps" %>
            ...
            <center>
                ...
                <tr>
                    ...
                    <td class="coll2">
                        ...
                        <asp:Calendar ID="Calendar2" Style="position:absolute" runat="server" OnDayRender="Calendar2_DayRender" OnSelectionChanged="Calendar2_SelectionChanged" VisibleDate="2022-08-26" BackColor="White" BorderColor="Black" BorderStyle="Solid" CellSpacing="1" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="250px" NextPrevFormat="FullMonth" Width="330px">
                            <DayHeaderStyle Font-Bold="True" Font-Size="8pt" ForeColor="#333333" Height="8pt" />
                 <DayStyle BackColor="#CCCCCC" />
                 <NextPrevStyle Font-Bold="True" Font-Size="8pt" ForeColor="White" />
                 <OtherMonthDayStyle ForeColor="#999999" />
                ...
                <tr>
                    ...
                    <td class="coll2">
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator8" ValidationExpression="([a-zA-Z0-9\s_\\.\-:])+(.jpg|.JPG|.jpeg|.JPEG|.png|.PNG)" runat="server" ControlToValidate="FileUpload1" ErrorMessage="INVALID FILE FORMAT!" ForeColor="white"></asp:RegularExpressionValidator>
                    </td>
                    <td class="auto-style4">
                        &nbsp;</td>
                </tr>
