<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admineditaward.aspx.cs" Inherits="NSS_admineditawardaspx" %>
...
<form id="form1" runat="server">
    <center>
        <div class="container">
          ...
          <%--<h1 align="center">EDIT AWARD</h1>--%>
         <asp:GridView ID="GridView1" runat="server" AllowPaging="True" DataKeyNames="award_id" AllowSorting="True" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SqlDataSource1" ForeColor="Black" Width="1358px">
             <Columns>
                 ...
                 <asp:BoundField DataField="course_year" HeaderText="COURSE BATCH" SortExpression="course_year" />
                 ...
                 <asp:BoundField DataField="awardrecived_year" HeaderText="RECEIVED YEAR" SortExpression="awardrecived_year" />
