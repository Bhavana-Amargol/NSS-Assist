...
public partial class NSS_certificate : System.Web.UI.Page
{
    SqlConnection con;
    SqlConnection con1;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string s = "select * from certificate";
            con.Open();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                FileUpload1.SaveAs(@Server.MapPath("~\\NSS\\Uploads\\certificate\\" + FileUpload1.FileName));
            ...
            string s = "select * from certificate where  certificate_id= " + "'" + TextBox1.Text + "'";
            con.Open();
            SqlCommand cmd1 = new SqlCommand(s, con);
            SqlDataReader reader;
            ...
            if (ctr == 0)
            {
                ...
                s = "insert into certificate values(@1,@2,@3,@4,@5,@6,@7,@8,@9)";
                Response.Write(s);
               ...
               // cmd1.Parameters.Add("@7", TextBox7.Text);
                ...
                con.Close();
                Response.Write("<script>alert('Certificates Added successfully!!!');window.location='certificate.aspx';</script>");
            ...
            {
                Response.Write("<script>alert('couldn't add certificate details.Details already exist ');window.location='certificate.aspx';</script>");
