<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calcamps.aspx.cs" Inherits="NSS_calcamps" %>
...
<form id="form1" runat="server">
    ...
    <h1 align="center">ADD CALENDAR OF CAMPS</h1>
        <center>
            <table align="center" class="container1" >
            <tr hidden="hidden">
                <td class="coll">ccvent id</td>
            ...
            <tr>
                ...
                <td>
                 ...
                 <tr>
                <td class="coll"> Starting Date</td>
                <td class="coll2" align="center">
                    <asp:TextBox ID="TextBox4" runat="server" Font-Size="Large" Height="40px" type="date"></asp:TextBox>
                </td>
                <td>
            ...
            <tr><td>
                    &nbsp;</td></tr>
                     ...
                     <tr>
                <td class="coll"> Ending Date</td>
                <td class="coll2" align="center">
                    <asp:TextBox ID="TextBox5" runat="server" Font-Size="Large" Height="40px" type="date"></asp:TextBox>
                </td>
                <td>
            ...
            <tr><td>
                    &nbsp;</td></tr>
                 <tr>
                     <td class="coll">Duration</td>
                <td class="coll2" align="center">
                    <asp:TextBox ID="TextBox6"  runat="server" Font-Size="Large" Height="40px" placeholder="Ex:7 Days"></asp:TextBox>
               ...
               <tr>
                <td class="coll">&nbsp;</td>
                <td class="coll2" align="center">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="INVALID FORMAT!" ControlToValidate="TextBox6" Font-Size="Medium" ForeColor="Red" ValidationExpression="^[a-zA-Z0-9'/-@&amp;amp;#,.\s]{2,100}$"></asp:RegularExpressionValidator>
                </td>
                <td>
                    &nbsp;</td>
                </tr>
