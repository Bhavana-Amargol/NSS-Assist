...
public partial class NSS_deputycamps : System.Web.UI.Page
{
    SqlConnection con;
    SqlConnection con1;
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ctr == 0)
            {
                ...
                con.Close();
                Response.Write("<script>alert('Camp details added successfully!!!');window.location='deputycamps.aspx';</script>");
            ...
            {
                Response.Write("<script>alert('Couldnt add camp details. Details already exist! ');window.location='deputycamps.aspx';</script>");
